...
/**
 * Fetches a high-quality book cover from Google Books API
 * @param {string} bookTitle - The title of the book to search for
 * @returns {Promise<string|null>} - URL of the book cover or null if not found
 */
            ...
            if (imageLinks) {
                ...
                for (const size of sizes) {
                    if (imageLinks[size]) {
                        ...
                        // Use the edge=nocurl parameter to get a flat cover image
...
/**
 * Fetches detailed information about a book including a high-quality cover
 * @param {string} bookTitle - The title of the book to search for
