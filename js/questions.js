...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const generatingContainer = document.getElementById('generating-questions-container');
    ...
    if (startQuizButton) {
        startQuizButton.addEventListener('click', async () => {
            const userConfirmed = window.confirm("Are you sure you want to start the quiz? Your progress will be lost if you leave.");
    ...
    function updateToggleIcon(theme) {
        // Implement your theme toggle icon update logic here
    }
});
