...
export async function POST(req: NextRequest) {
  try {
    ...
    // Bootstrap exception: a user enrolling their first verified factor
    // (passkey or TOTP) is allowed at AAL1 — that's how MFA gets bootstrapped.
    // Once any verified factor exists, adding another factor requires AAL2.
