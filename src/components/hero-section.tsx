...
export function HeroSection({ onMovieClick, onBookClick, userLoggedIn = false }: HeroSectionProps) {
    ...
    >
      ...
      <div className="relative z-10 w-full">
        ...
        >
            ...
            {movieImages.map((image, index) => (
              <motion.div
                ...
                transition={{
                  ...
                  float: { duration: 6, repeat: Infinity, delay: index * 0.2, ease: 'easeInOut' },
                }}
              >
                <img
                  src={image}
          ...
          {/* Center - Main Content */}
          <motion.div className="flex-1 flex flex-col items-center justify-center text-center" variants={containerVariants}>
            ...
            <motion.p variants={itemVariants} className="text-lg md:text-xl text-slate-400 dark:text-slate-300 light:text-slate-600 max-w-2xl mb-10">
              Smart Advisor uses advanced AI to understand your taste and recommend the perfect movie or book just for you.
              Answer a quick survey and get personalized picks.
            </motion.p>
            ...
            <motion.p variants={itemVariants} className="text-sm text-slate-500 dark:text-slate-400 light:text-slate-600 mt-8">
          ...
          >
            {bookImages.map((image, index) => (
              <motion.div
                ...
                transition={{
                  initial: { duration: 0.6 },
                  float: { duration: 6, repeat: Infinity, delay: (2 - index) * 0.2, ease: 'easeInOut' },
                }}
              >
                <img
                  src={image}
      ...
      >
        <div className="flex flex-col items-center gap-2">
          <p className="text-xs text-slate-500 dark:text-slate-400 light:text-slate-600">Scroll to explore</p>
          <svg className="w-5 h-5 text-slate-400 dark:text-slate-500 light:text-slate-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
