...
mixin _$FeedComment {
 ...
 String get id; String get author; String get body;@JsonKey(name: 'age_hours') int get ageHours; int get score;/// Reddit/Lemmy-style threading. null = top-level comment.
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,author,body,ageHours,score,parentId);

@override
String toString() {
  return 'FeedComment(id: $id, author: $author, body: $body, ageHours: $ageHours, score: $score, parentId: $parentId)';
}
...
@useResult
$Res call({
 String id, String author, String body,@JsonKey(name: 'age_hours') int ageHours, int score,@JsonKey(name: 'parent_id') String? parentId
});
...
/// Create a copy of FeedComment
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? author = null,Object? body = null,Object? ageHours = null,Object? score = null,Object? parentId = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String author,  String body, @JsonKey(name: 'age_hours')  int ageHours,  int score, @JsonKey(name: 'parent_id')  String? parentId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FeedComment() when $default != null:
return $default(_that.id,_that.author,_that.body,_that.ageHours,_that.score,_that.parentId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String author,  String body, @JsonKey(name: 'age_hours')  int ageHours,  int score, @JsonKey(name: 'parent_id')  String? parentId)  $default,) {final _that = this;
switch (_that) {
case _FeedComment():
return $default(_that.id,_that.author,_that.body,_that.ageHours,_that.score,_that.parentId);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String author,  String body, @JsonKey(name: 'age_hours')  int ageHours,  int score, @JsonKey(name: 'parent_id')  String? parentId)?  $default,) {final _that = this;
switch (_that) {
case _FeedComment() when $default != null:
return $default(_that.id,_that.author,_that.body,_that.ageHours,_that.score,_that.parentId);case _:
  return null;
...
class _FeedComment extends FeedComment {
  const _FeedComment({required this.id, required this.author, required this.body, @JsonKey(name: 'age_hours') required this.ageHours, this.score = 0, @JsonKey(name: 'parent_id') this.parentId}): super._();
...
/// Create a copy of FeedComment
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? author = null,Object? body = null,Object? ageHours = null,Object? score = null,Object? parentId = freezed,}) {
...
mixin _$FeedPost {
 ...
 String get id; FeedCommunity get community; String get author; String get title;@JsonKey(name: 'age_hours') int get ageHours; FeedActivity get activity;/// Taste overlap with the current user, 0–100 (in-memory mock).
@JsonKey(name: 'taste_match') int get tasteMatch; String? get body;/// Optional tag (Discussion / Recommendation / etc.).
 String? get flair;@JsonKey(name: 'poster_url') String? get posterUrl; String? get creator; int? get year; bool get square;@JsonKey(name: 'base_score') int get baseScore;/// -1, 0 or 1 — the current user's vote (in-memory only).
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,community,author,title,ageHours,activity,tasteMatch,body,flair,posterUrl,creator,year,square,baseScore,vote,const DeepCollectionEquality().hash(comments));

@override
String toString() {
  return 'FeedPost(id: $id, community: $community, author: $author, title: $title, ageHours: $ageHours, activity: $activity, tasteMatch: $tasteMatch, body: $body, flair: $flair, posterUrl: $posterUrl, creator: $creator, year: $year, square: $square, baseScore: $baseScore, vote: $vote, comments: $comments)';
}
...
@useResult
$Res call({
 String id, FeedCommunity community, String author, String title,@JsonKey(name: 'age_hours') int ageHours, FeedActivity activity,@JsonKey(name: 'taste_match') int tasteMatch, String? body, String? flair,@JsonKey(name: 'poster_url') String? posterUrl, String? creator, int? year, bool square,@JsonKey(name: 'base_score') int baseScore, int vote, List<FeedComment> comments
});
...
/// Create a copy of FeedPost
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? community = null,Object? author = null,Object? title = null,Object? ageHours = null,Object? activity = null,Object? tasteMatch = null,Object? body = freezed,Object? flair = freezed,Object? posterUrl = freezed,Object? creator = freezed,Object? year = freezed,Object? square = null,Object? baseScore = null,Object? vote = null,Object? comments = null,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,community: null == community ? _self.community : community // ignore: cast_nullable_to_non_nullable
as FeedCommunity,author: null == author ? _self.author : author // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  FeedCommunity community,  String author,  String title, @JsonKey(name: 'age_hours')  int ageHours,  FeedActivity activity, @JsonKey(name: 'taste_match')  int tasteMatch,  String? body,  String? flair, @JsonKey(name: 'poster_url')  String? posterUrl,  String? creator,  int? year,  bool square, @JsonKey(name: 'base_score')  int baseScore,  int vote,  List<FeedComment> comments)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FeedPost() when $default != null:
return $default(_that.id,_that.community,_that.author,_that.title,_that.ageHours,_that.activity,_that.tasteMatch,_that.body,_that.flair,_that.posterUrl,_that.creator,_that.year,_that.square,_that.baseScore,_that.vote,_that.comments);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  FeedCommunity community,  String author,  String title, @JsonKey(name: 'age_hours')  int ageHours,  FeedActivity activity, @JsonKey(name: 'taste_match')  int tasteMatch,  String? body,  String? flair, @JsonKey(name: 'poster_url')  String? posterUrl,  String? creator,  int? year,  bool square, @JsonKey(name: 'base_score')  int baseScore,  int vote,  List<FeedComment> comments)  $default,) {final _that = this;
switch (_that) {
case _FeedPost():
return $default(_that.id,_that.community,_that.author,_that.title,_that.ageHours,_that.activity,_that.tasteMatch,_that.body,_that.flair,_that.posterUrl,_that.creator,_that.year,_that.square,_that.baseScore,_that.vote,_that.comments);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  FeedCommunity community,  String author,  String title, @JsonKey(name: 'age_hours')  int ageHours,  FeedActivity activity, @JsonKey(name: 'taste_match')  int tasteMatch,  String? body,  String? flair, @JsonKey(name: 'poster_url')  String? posterUrl,  String? creator,  int? year,  bool square, @JsonKey(name: 'base_score')  int baseScore,  int vote,  List<FeedComment> comments)?  $default,) {final _that = this;
switch (_that) {
case _FeedPost() when $default != null:
return $default(_that.id,_that.community,_that.author,_that.title,_that.ageHours,_that.activity,_that.tasteMatch,_that.body,_that.flair,_that.posterUrl,_that.creator,_that.year,_that.square,_that.baseScore,_that.vote,_that.comments);case _:
  return null;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,community,author,title,ageHours,activity,tasteMatch,body,flair,posterUrl,creator,year,square,baseScore,vote,const DeepCollectionEquality().hash(_comments));
