...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,email,name,age,createdAt,username,mfaEnabled,lastLogin,backupEmail,avatarUrl,contentTone,locale,setupCompletedAt,const DeepCollectionEquality().hash(recommendationFilters),bio,const DeepCollectionEquality().hash(interests),const DeepCollectionEquality().hash(tags));

@override
String toString() {
  return 'AppUser(id: $id, email: $email, name: $name, age: $age, createdAt: $createdAt, username: $username, mfaEnabled: $mfaEnabled, lastLogin: $lastLogin, backupEmail: $backupEmail, avatarUrl: $avatarUrl, contentTone: $contentTone, locale: $locale, setupCompletedAt: $setupCompletedAt, recommendationFilters: $recommendationFilters, bio: $bio, interests: $interests, tags: $tags)';
}
...
switch (_that) {
case _AppUser() when $default != null:
return $default(_that.id,_that.email,_that.name,_that.age,_that.createdAt,_that.username,_that.mfaEnabled,_that.lastLogin,_that.backupEmail,_that.avatarUrl,_that.contentTone,_that.locale,_that.setupCompletedAt,_that.recommendationFilters,_that.bio,_that.interests,_that.tags);case _:
  return orElse();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,email,name,age,createdAt,username,mfaEnabled,lastLogin,backupEmail,avatarUrl,contentTone,locale,setupCompletedAt,const DeepCollectionEquality().hash(_recommendationFilters),bio,const DeepCollectionEquality().hash(_interests),const DeepCollectionEquality().hash(_tags));
